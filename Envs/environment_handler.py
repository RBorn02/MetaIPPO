        ...
        for a, i in zip(agent_ids, range(len(agent_ids))):
            ...
            for env in obs_in.keys():
                ...
                if "agent_{0}".format(i) in obs_in[env].keys():
                    ...
                    if "success_stage_1" in info[env]["agent_{0}".format(i)].keys():
                        stage_one_successes[0][env] = info[env]["agent_{0}".format(i)]["success_stage_1"]
                        stage_two_sucecsses[0][env] = info[env]["agent_{0}".format(i)]["success_stage_2"]
                        stage_three_successes[0][env] = info[env]["agent_{0}".format(i)]["success_stage_3"]
