...
class CoopCraftingEnv(MultiAgentEnv):
    ...
    def reset(self, seed=None, options=None):
        ...
        if self.coop:
            ...
            self.task_dict = self.sample_task_tree(3, end_conditions, possible_objects, element_coordinates, 
            ...
            self.task_dict_agent_1 = self.sample_task_tree(3, end_conditions, possible_objects.copy(), element_coordinates.copy(),
